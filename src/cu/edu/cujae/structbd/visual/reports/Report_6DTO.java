 ...
 * @author Amaya
 */
public class Report_6DTO extends javax.swing.JDialog {

    /**
     * Creates new form Report_6DTO
     */
    public Report_6DTO(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        //FALTA PONER EL TEAM ID!!!!!
        if(jComboBox1.getSelectedIndex() != 0){
            try {
                initComponents();
                LinkedList<ReadReport_6DTO> list = new LinkedList<>(ServicesLocator.AppServices.getTeamStatus(" "));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_6DTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_6DTO dialog = new Report_6DTO(new javax.swing.JFrame(), true);
