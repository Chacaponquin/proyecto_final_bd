 ...
 * @author Jose
 */
public class PhaseUI extends javax.swing.JDialog
{

    /**
     * Creates new form PhaseUI
     */
    public PhaseUI(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                PhaseUI dialog = new PhaseUI(new javax.swing.JFrame(), true);
